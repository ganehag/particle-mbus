...
const mbus_variable_vif vif_table[] = {
    ...
    {0x6C, 1.0e0, "-",
     "Time point (date)"}, /* n = 0        date, data type G */
    {0x6D, 1.0e0, "-",
     "Time point (date & time)"}, /* n = 1 time & date, data type F */
    ...
    /* E111 00nn Cold / Warm Temperature Limit 10(nn-3) °F 0.001°F to
       1°F */
    ...
    /* E111 01nn Cold / Warm Temperature Limit 10(nn-3) °C 0.001°C to
       1°C */
