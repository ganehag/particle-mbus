...
public:
    ...
    void decodeBin(unsigned char *dst, const unsigned char *src, size_t len, size_t max_len);
    void decodeTM(struct tm *t, size_t t_data_size);
    int decodeValue(double *value_out_real, char **value_out_str, int *value_out_str_size);
